    <main>
        <div class="login-block">
            ...
            <form method="post">
                ...
                <button class="btn btn-primary btn-block" type="submit" name="registration">ЗАРЕГИСТРИРОВАТЬСЯ</button>
            </form>
        </div>
    <div class="login-links">
        <p class="text-center">Уже есть аккаунт? <a class="txt-brand" href="index.php?c=page&act=login"><font color=#29aafe>Авторизуйтесь</font></a></p>
    </div>
 </main>